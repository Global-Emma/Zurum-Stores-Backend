...
const createProducts = async (req, res) => {
  try {
    ...
    await inValidateCache(req.redisClient, 'all_products');
...
const getAllProducts = async (req, res) => {
  try {
    ...
    // create cached products 
    const cachedProducts = await req.redisClient.get(cacheKey)

    // check if products is already in the cache and return the products
    if (cachedProducts) {
    ...
    // if not find the products from database 
